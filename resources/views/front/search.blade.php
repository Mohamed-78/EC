    ...
    <div class="container">
        <div class="page-title-content">
            ...
            <ul>
                ...
                <li style="color: white;">Produits</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="products-filter-options">
                 ...
                 @if($search->count()>0)
                    <div class="col-md-12">
                       @if(request()->input())
                       <h5 style="text-align: center;color: red;padding-bottom: 3em;">
                        {{ $search->count() }} résultat(s) pour la recherche "{{ request()->q }}"</h5>
                        @endif
                    </div>
                @endif
                @if($search->count()>0)
                <div id="products-collections-filter" class="row">
                    ...
                    @foreach($search as $ann)
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-shop-products">
                            <div class="shop-products-image">
                                <a href="/cogitech/details/serveur/{{ $ann->id }}"><img src="{{URL::asset('admin/media/'.$ann->photo)}}" alt="image"></a>
                                ...
                                <ul class="shop-action">
                                    ...
                                    <li>
                                        <a href="/cogitech/details/serveur/{{ $ann->id }}"><i class="flaticon-view"></i></a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="shop-products-content">
                                <h3>
                                    <a href="/cogitech/details/serveur/{{ $ann->id }}">{{ $ann->titre }}</a>
                                </h3>
                                <ul class="rating">
                                    <li><i class='bx bxs-star'></i></li>
                                    <li><i class='bx bxs-star'></i></li>
                ...
                @else
                <h5 style="color: red;text-align: center;">Aucune offre promotionnelle</h5>
                @endif
            </div>
        </div>
    </div>
