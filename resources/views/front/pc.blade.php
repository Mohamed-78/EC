                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-shop-products">
                            <div class="shop-products-image">
                                <a href="/cogitech/details/pc/{{ $ann->id }}"><img src="{{URL::asset('admin/media/'.$ann->photo)}}" alt="image"></a>
                                ...
                                <ul class="shop-action">
                                    ...
                                    <li>
                                        <a href="/cogitech/details/pc/{{ $ann->id }}"><i class="flaticon-view"></i></a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="shop-products-content">
                                <h3>
                                    <a href="/cogitech/details/pc/{{ $ann->id }}">{{ $ann->titre }}</a>
                                </h3>
                                <ul class="rating">
                                    <li><i class='bx bxs-star'></i></li>
                                    <li><i class='bx bxs-star'></i></li>
