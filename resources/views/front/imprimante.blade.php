...
<div class="page-title-area">
    <div class="container">
        <div class="page-title-content">
            <h2 style="color: white;">NOS IMPRIMANTES</h2>

            <ul>
                <li><a href="{{ route('accueil') }}" style="color: white;">Accueil</a></li>
                <li style="color: white;">Imprimantes</li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-shop-products">
                            <div class="shop-products-image">
                                <a href="/cogitech/details/imprimante/{{ $ann->id }}"><img src="{{URL::asset('admin/media/'.$ann->photo)}}" alt="image"></a>
                                ...
                                <ul class="shop-action">
                                    ...
                                    <li>
                                        <a href="/cogitech/details/imprimante/{{ $ann->id }}"><i class="flaticon-view"></i></a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="shop-products-content">
                                <h3>
                                    <a href="/cogitech/details/imprimante/{{ $ann->id }}">{{ $ann->titre }}</a>
                                </h3>
                                <ul class="rating">
                                    <li><i class='bx bxs-star'></i></li>
                                    <li><i class='bx bxs-star'></i></li>
