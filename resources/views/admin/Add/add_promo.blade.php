  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">FAIRE UNE PROMOTION</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="/cogitech/save/promo" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            ...
            <div class="form-group col-sm-6">
               <label class="control-label">La reduction</label>
                <input type="text" class="form-control" name="reduction" placeholder="Ex: -50%" required="">
            </div>
             <div class="form-group col-sm-6">
               <label class="control-label">Ancien prix [<span style="color: red;">Uniquement des chiffre, pas d'espace aussi</span>]</label>
                <input type="number" class="form-control" name="ancPrice" placeholder="Ancien prix" required="">
            </div>
            <div class="form-group col-sm-6">
               <label class="control-label">Nouveau prix [<span style="color: red;">Uniquement des chiffre, pas d'espace aussi</span>]</label>
                <input type="number" class="form-control" name="newPrice" placeholder="Nouveau prix" required="">
            </div>
            <div class="form-group col-sm-6">
               <label class="control-label">Date debut</label>
                <input type="date" class="form-control" name="date_debut" placeholder="Le prix" required="">
            </div>
            <div class="form-group col-sm-6">
               <label class="control-label">Date fin</label>
                <input type="date" class="form-control" name="date_fin" placeholder="Le prix" required="">
            </div>
            <div class="form-group col-sm-6">
