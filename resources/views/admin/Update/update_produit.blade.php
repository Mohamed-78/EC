  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/cogitech/updated/prod/{{ $single->id }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            ...
            <div class="form-group col-sm-6">
               <label class="control-label">Le prix [<span style="color: red;">Uniquement des chiffre, pas d'espace aussi</span>]</label>
                <input type="number" class="form-control" name="prix" placeholder="La" required="" value="{{ $single->prix }}">
            </div>
            <div class="form-group col-sm-6">
